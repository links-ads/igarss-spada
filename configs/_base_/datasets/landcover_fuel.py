...
# Eroded Fuel Rare Class Sampling Weights
rcs_classprob = [
    0.1218, 0.1231, 0.1231, 0.1208, 0.0944, 0.0953, 0.1099, 0.1125, 0.0991
]
...
data = dict(
    ...
    train=dict(
        ...
        # Fuel
        # ann_dir='Train/Tiles/Fuel',
        # Filtered Fuel
        # ann_dir='Train/Tiles/FilteredFuel',
        # Eroded Fuel
        # ann_dir='Train/Tiles/FilteredEroded',
        # Scribble
        ann_dir='Train/Tiles/Scribble',
        # LUCAS
        # ann_dir='Train/Tiles/FilteredFuel',
        # weight_dir='Train/Tiles/Dist',
        ...
        rcs_enabled=False),
    # samples_with_class_path='tools/eroded_samples_with_class.json',
